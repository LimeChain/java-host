...
class BabeConsensusMessageReaderTest {

    @Test
    void testReadFormatOne() {
        ...
        BabeConsensusMessage babeConsensusMessage = ScaleUtils.Decode.decode(bytes, BabeConsensusMessageReader.getInstance());
